  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30">
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xl w-full max-w-md p-6">
        <h2 className="text-lg font-bold text-slate-900 mb-4" style={{ fontFamily: "var(--font-syne)" }}>
          {title}
        </h2>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={loading}
            className="flex-1 py-2.5 rounded-xl bg-brand-800 text-white font-semibold hover:bg-brand-900 transition-colors disabled:opacity-50"
          >
