    ...
    >
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          <Link
            href="/register"
            className="inline-flex items-center justify-center gap-2 font-semibold text-sm px-7 py-4 rounded-xl transition-all duration-200 active:scale-95 hover:opacity-90 w-full sm:w-auto"
          ...
          <Link
            href="#features"
            className="inline-flex items-center justify-center gap-2 font-semibold text-sm px-7 py-4 rounded-xl transition-all duration-200 hover:opacity-80 w-full sm:w-auto"
            style={{
              color: "#9FB8C9",
